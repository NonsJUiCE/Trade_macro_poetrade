...
GetLatestRelease(user, repo, ReleaseVersion, ShowUpdateNotification, userDirectory, isDevVersion, skipSelection, skipBackup, SplashScreenTitle = "", debug = 0, repeatedCheck = false) {
	...
	url			:= "https://github.com/NonsJUiCE/Trade_macro_poetrade.git"
	downloadUrl	:= "https://github.com/NonsJUiCE/Trade_macro_poetrade.git"
	html			:= ""
	...
	Try  {
		...
		downloadURL_zip 	:= "https://github.com/NonsJUiCE/Trade_macro_poetrade.git" . downloadFile
		downloadURL_asset 	:= ""
